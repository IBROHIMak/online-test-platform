...
const testData = {
    ...
    mathematics: {
        ...
        duration: 60,
        questions: [
            {id: 1, question: "∫(2x + 3)dx integralni hisoblang", options: ["x<sup>2</sup> + 3x + C", "2x<sup>2</sup> + 3x + C", "x<sup>2</sup> + 3 + C", "2x + 3x + C"], correct: 0},
            {id: 2, question: "lim(x→0) (sin x)/x ning qiymati nechaga teng?", options: ["0", "1", "∞", "Mavjud emas"], correct: 1},
            {id: 3, question: "Matritsaning determinanti qachon 0 ga teng bo'ladi?", options: ["Hech qachon", "Matritsaning rangi to'liq bo'lmaganda", "Har doim", "Faqat 2×2 matritsalarda"], correct: 1},
            {id: 4, question: "f(x) = x<sup>3</sup> - 3x<sup>2</sup> + 2 funksiyaning ekstremum nuqtalari sonini toping", options: ["0", "1", "2", "3"], correct: 2},
            {id: 5, question: "Kompleks son i<sup>2</sup> ning qiymati nima?", options: ["1", "-1", "i", "0"], correct: 1},
            ...
            {id: 8, question: "e<sup>iπ</sup> + 1 = ? (Eyler formulasi)", options: ["0", "1", "e", "π"], correct: 0},
    ...
    physics: {
        ...
        questions: [
            ...
            {id: 4, question: "E = mc<sup>2</sup> formulasida c nima?", options: ["Yorug'lik tezligi", "Issiqlik sig'imi", "Zaryad", "Kuch"], correct: 0},
            ...
            {id: 17, question: "Planck doimiysi (h) qaysi formulada?", options: ["E = hν", "E = mc<sup>2</sup>", "F = ma", "pV = nRT"], correct: 0},
    ...
    chemistry: {
        ...
        duration: 60,
        questions: [
            {id: 1, question: "Suvning kimyoviy formulasi?", options: ["H<sub>2</sub>O", "HO<sub>2</sub>", "H<sub>3</sub>O", "H<sub>2</sub>O<sub>2</sub>"], correct: 0},
            ...
            {id: 8, question: "Kislota + ishqor = ?", options: ["Tuz va suv (H<sub>2</sub>O)", "Gaz", "Metall", "Yog'"], correct: 0},
            {id: 9, question: "Avogadro soni?", options: ["6.02×10<sup>22</sup>", "6.02×10<sup>23</sup>", "6.02×10<sup>24</sup>", "6.02×10<sup>25</sup>"], correct: 1},
